...
public class Plant extends Replenishable {
    ...
    public void display(GraphicsContext graphics) {
        graphics.setFill(this.equals(World.selectedObject) ? Color.web("efeff0") : Color.web("1b998b"));
        graphics.fillRect(this.getX(), this.getY(), 1, 1);
    }

    public static ArrayList<Plant> generatePlants(int GRID_SIZE, Set<Point> points, int number,
